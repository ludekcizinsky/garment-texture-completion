...
\subsection{Showcase of the Best Model's Predictions in 3D}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{figures/3d_examples.png}
  \caption{\textbf{Showcase of the Best Model's Predictions in 3D.} The model's prediction mapped to a 3D mesh.}
  \label{fig:3d-showcase}
\end{figure}
